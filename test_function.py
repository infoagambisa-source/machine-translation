...
from training_model import encoder_input_data, num_decoder_tokens, latent_dim # retained only the data and constants

from tensorflow import keras
from keras.layers import Input # dropped LSTM, Dense
